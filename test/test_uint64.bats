...
@test "uint64 - with value between max int and max uint" {
...
@test "uint64 - much bigger than max uint" {
...
@test "uint64 - leading zeros does not convert to octal" {
...
@test "uint64 - from environment variable" {
