...
@test "err double - with normal value" {
...
@test "err double - with a negative value" {
  run build/example_with_error_message some_double=-0.0012345
  [ $status -eq 0 ]
...
@test "err double - with a fraction" {
...
@test "err double - from environment variable" {
