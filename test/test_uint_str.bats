...
@test "str uint - with value between max int and max uint" {
...
@test "str uint - much bigger than max uint" {
...
@test "str uint - from environment variable" {
